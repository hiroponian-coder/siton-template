  ...
  return (
    <section className="py-24 px-4 bg-theme-bg">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-theme-surface p-8 md:p-12 rounded-2xl shadow-sm border border-theme-secondary/5 relative overflow-hidden">
          ...
          {profile.design_atmosphere && (
            <div className="mb-10">
              <h3 className="flex items-center justify-center gap-2 text-xl font-semibold text-theme-secondary mb-4">
